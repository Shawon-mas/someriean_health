...
class _PackagesListScreenState extends State<PackagesListScreen> {
  final CollectionReference _packages=FirebaseFirestore.instance.collection(DbCollections.collectionHealthPackages);
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Stack(
                              children: [
                                Image.network(documentSnapshot['image'],width: double.infinity,fit: BoxFit.cover,),
                                Positioned(
                                  bottom: 0,
                                    left: 0,
                                    right: 0,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Icon(Icons.arrow_forward_ios_rounded,size: 15.sp,color: Properties.primaryColor,)
                                  ],
                                )
                              ],
                            ),
