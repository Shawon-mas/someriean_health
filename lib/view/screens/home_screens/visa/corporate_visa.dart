...
class CorporateVisa extends StatelessWidget {
  final controller = Get.put(VisaScreeningController());
  final String title;
  CorporateVisa({Key? key, required this.title}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              customTextField(
                  enabled: true,
                  textEditingController: controller.c_representativeNameController,
                  helperText: "Company Representative  Name"),
              const SizedBox(
                height: 10,
              ),
              customTextField(
                  enabled: true,
                  textEditingController: controller.c_numberOfPeopleController,
              ...
              Obx(() => AppointmentButton(
                ...
                onPressed: () {
                  if (controller.c_nameController.text.isEmpty) {
                  ...
                  }else if (controller.c_representativeNameController.text.isEmpty) {
                    errorSnackBar(context, 'Company Representative Name Required');
                  }else if (controller.c_numberOfPeopleController.text.isEmpty) {
                    errorSnackBar(context, 'Company Number of People Required');
                    ...
                    controller.bookCorporateVisa(context);
                  }
                },
                value: 'Proceed',
              )),
