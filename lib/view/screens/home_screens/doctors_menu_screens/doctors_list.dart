                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                         ...
                         /* List<LocationDatum?> locationData = _controller.locations;
                          String location = locationData[index]!.hospitalLocationName!.toString();

                          List<Datum?> specialityData = _controller.speciality;
                          String speciality =
                              specialityData[index]!.doctorSpecialitiesName!;*/
                            ...
                            return Obx(() => (_controller.selectedLocation.value == "" &&
                                ...
                                : Visibility(
                                    visible: _controller.selectedLocation.value ==
                                        doctorListData[index]!.doctorProfileHospitalLocationName! &&
                                        _controller.selectedSpeciality.value ==
                                            doctorListData[index]!.doctorProfileSpecialitiesName!,
                                    child: doctorList(
                                        doctorListData[index], context)));
                          } else if (doctorListData[index]!
                                  .doctorProfileName!
                                  .toString()
                                  .toLowerCase()
